...
type BaseModel struct {
	...
	CreatedAt *sql.NullTime `gorm:"column:created_at;autoCreateTime;type:datetime not null default current_timestamp;comment:创建时间" json:"createdAt" swaggertype:"primitive,string"`
	UpdatedAt *sql.NullTime `gorm:"column:updated_at;autoUpdateTime;type:datetime not null default current_timestamp on update current_timestamp;comment:更新时间" json:"updatedAt" swaggertype:"primitive,string"`
}
